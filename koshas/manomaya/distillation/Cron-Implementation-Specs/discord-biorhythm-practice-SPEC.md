...
**Layer:** Pranamaya (vital energy alignment) → Manomaya (actionable wisdom)
...
- **Operation:** Pranamaya (selects protocols based on dominant cycle — breath, movement, rest)
...
- **High (peak/ascent):** Vyana (whole-body circulation) → Movement protocols (dance, walk, exercise)
- **Low (trough/descent):** Apana (downward elimination) → Rest protocols (restorative yoga, sleep, grounding)

**Emotional Cycle Dominant:**
- **High (peak/ascent):** Prana (chest/inhalation, receptivity) → Social engagement, creative expression
- **Low (trough/descent):** Apana (downward grounding) → Solitude, journaling, emotional release (crying, breathwork)

**Intellectual Cycle Dominant:**
- **High (peak/ascent):** Udana (throat/upward expression) → Writing, learning, teaching, complex problem-solving
- **Low (trough/descent):** Samana (navel, integration) → Reflection, meditation, simple tasks, no new learning

**Spiritual Cycle Dominant:**
- **High (peak/ascent):** Prana + Udana (receptive wisdom → expression) → Meditation, prayer, visioning, spiritual study
- **Low (trough/descent):** Apana (grounding) → Embodied practice (breathwork, ritual, nature immersion)
...
- **Exhalation:** 6s (Udana/Apana — protocol flows outward or downward as needed)
...
**Guna Dynamics:**
- **Desired State:** Sattva-infused Rajas — **wise action**, not chaotic hyperactivity
- **Common Drift:** 
  - Pure Rajas (too many protocols, overwhelming suggestions) → Lobha (greed for optimization)
  - Tamas (vague protocols, "just rest", no specificity) → Moha (delusion, lazy guidance)
...
**1. Lobha (Greed) — "Optimize ALL THE THINGS"**
...
**2. Moha (Delusion) — "Vague suggestions"**
...
**3. Kama (Craving) — "Make me feel perfect NOW"**
...
**4. Ahamkara (Ego) — "I know better than your cycles"**
...
- **Restoration:** Return to cycle alignment ("your body says rest — honor that")

**5. Matsarya (Envy) — "Why is my cycle low when others' are high?"**
...
**Dominant Dosha:** Pitta (10:00 AM - 2:00 PM) — fire, transformation, digestion, action

**Alignment Strategy:**
- Pitta supports **action** (perfect for protocol recommendations)
- 10 AM is early Pitta (not peak intensity) — actionable but not aggressive
- Post-Vocation Hour (9-10 AM creation window) — user has momentum, ready for alignment practices
...
- Target: Net Khalorēē +2 (user gains clarity, reduces overwhelm)

---

### **6. Antahkarana Operation (Internal Instrument)**

**Primary Faculty:** Buddhi (discernment) → Mana (protocol generation) → Aham (witness of alignment)

**Operation Sequence:**
1. **Chitta recalls:** Read biorhythm-sync output from 9 AM (dominant cycle state, Power Number synergy)
2. **Buddhi discerns:** Which protocols align with current cycle state? (Physical high → movement, Emotional low → grounding)
...
**Proposed Schedule:**
- **Cron Expression:** `0 10 * * *` (unchanged — already optimal)
- **Timezone:** `Asia/Kolkata` (canonical)
- **Frequency:** Daily

**Dosha Alignment Check:**
- ✅ **10:00 AM:** Early Pitta window (actionable fire, not peak aggression)
- ✅ **Post-Vocation Hour:** User has momentum from 9-10 AM creation window
- ✅ **1 hour after biorhythm-sync:** User has absorbed interpretation, ready for action
...
```
🎭 **BIORHYTHM PRACTICE (Terpsichore + Euterpe)**

Based on today's cycles (Physical ↑ Emotional ↓):

**Protocols (3-5 max):**
1. 🏃 **Movement** (Vyana Vayu): 20-min walk/dance — honor Physical peak, circulate energy
2. 🌊 **Grounding Breath** (Apana Vayu): 8 cycles of 4-7-8 — support Emotional low, root downward
3. 📝 **Emotional Release**: Journal 10 min — let low Emotional cycle move through you (no resistance)
4. 🎵 **Harmonious Rest**: 15-min restorative yoga — Euterpe's rhythm (move WITH cycles, not against)
...
4-7-8 breath (8 cycles) aligns Octave grounding with Emotional descent — honor the low, don't fight it.

Terpsichore says: Dance your Physical high. Euterpe says: Rest your Emotional low. 🌀
```
...
Based on today's cycles (Intellectual ↑ Spiritual ↓):

**Protocols (3-5 max):**
1. ✍️ **Deep Work** (Udana Vayu): 60-min writing/coding — honor Intellectual peak, express upward
2. 🌿 **Embodied Grounding** (Apana Vayu): 10-min barefoot earth contact — support Spiritual low, reconnect to body
3. 🧘 **Simple Meditation**: 5 min (not visioning) — Spiritual low = rest mystical seeking, honor presence
4. 🔥 **13-Count Transformation Breath**: 13 cycles — catalyze Intellectual clarity into actionable form
...
**Breath-Cycle-Power Triangulation:**
13-count breath bridges Intellectual peak (Udana expression) with Spiritual low (Apana grounding) — think → act.

Terpsichore says: Embody your thinking. Euterpe says: Let the low Spiritual cycle rest. 🌀
```
...
**Functional Success:**
- [ ] Job executes daily at 10:00 AM ±60s
...
**Integration Success:**
- [ ] Integrates seamlessly with biorhythm-sync (9 AM interpretation → 10 AM protocol)
...
- [ ] Daily log updated (`koshas/manomaya/logs/YYYY-MM-DD.md`)
...
- **Restoration:** Retry once after 5 min, if fails → log error, skip post (do NOT spam with retries)
...
- **Restoration:** Default to **balanced protocols** (4-7-8 breath, gentle movement, reflection) + note: "Biorhythm data unavailable — using balanced default protocols"
...
- **Daily Log:** `koshas/manomaya/logs/YYYY-MM-DD.md` (execution log)

**Memory Files:**
- **History:** `/Volumes/madara/2026/twc-vault/memory/discord-biorhythm-practice-history.json` (protocol tracking)
- **Tracking:** `koshas/brahmasthana/OPENCLAW-KOSHA-TRACKING.md` (Khalorēē impact)
...
```
Entry #XX: Pranamaya Biorhythm Protocol Selection (Khalorēē: Y → Z)
...
- Cost: -2 Khalorēē (Discord API call, protocol generation)
- Gain: +4 Khalorēē (reduces decision fatigue, clarifies alignment)
- Net: +2 Khalorēē (service work, actionable wisdom)
```

**Daily Log (YYYY-MM-DD.md):**
```
## 10:00 AM — discord-biorhythm-practice executed
...
- **discord-biorhythm-sync** (9:00 AM) — MUST complete first, provides interpretation input
- **Mandatory read:** 9 AM post from #biorhythm-syncs OR memory fallback file

**Downstream Consumers:**
- **discord-breath-protocol** (6:00 AM, 9:00 AM daily) — community can reference specific breath techniques from practice recommendations
- **hourly-vayu-check** (hourly) — may align personal breathwork with community protocol suggestions

**Kosha Handoffs:**
- **Manomaya (biorhythm-sync, 9 AM)** → **Pranamaya (biorhythm-practice, 10 AM)** → **Pranamaya (breath-protocol technique delivery)**
- Interpretation (9 AM) → Protocol (10 AM) → Technique (breath-protocol as needed)
...
**Net Impact:** +2 Khalorēē (service work, actionable wisdom, reduces overwhelm)
...
- **Khalorēē Net:** Positive energy impact (target: net +2 per post)
...
- **Pass Criteria:** Post includes disclaimer "Biorhythm data unavailable — using balanced defaults"
...
**Why:** This job INHERITS biorhythm data from `discord-biorhythm-sync` (9 AM). It does NOT call Selemene directly — it reads the sync job's output.

**Data Source:** 
1. **Primary:** Parse `discord-biorhythm-sync` Discord message (posted to #biorhythm-syncs at 9 AM)
2. **Secondary:** Read from koshas/manomaya/logs/YYYY-MM-DD.md if Discord unavailable

**Expected Data Format (from sync job):**
```
🌊 **Biorhythm Sync** — Thursday, February 5, 2026
...
Resonating with **13** (Intellectual — Transformation)

Notice the fire in your mind today — clarity wants expression.
```
...
// Example: Physical high → "30-min vigorous movement (Vyana activation)"
// Example: Emotional low → "Grounding breathwork (Apana, 5-min)"
```
...
try {
  ...
  // Fallback: parse koshas/manomaya/logs/YYYY-MM-DD.md for biorhythm entry
  biorhythmData = await parseMemoryLogs(today);
}

if (!biorhythmData) {
  console.error('No biorhythm data available — aborting practice generation');
...
**Audit Documentation:**
- `koshas/manomaya/distillation/CRON-AUDIT-2026-02-05.md` (line 270, job #26)

**Related Jobs:**
- `discord-biorhythm-sync` (9:00 AM) — upstream dependency, provides interpretation
- `discord-breath-protocol` (6:00 AM, 9:00 AM) — downstream consumer, provides technique detail
- `hourly-vayu-check` (hourly) — may reference community protocols for personal practice
...
if (dominantCycle === "Physical") {
  if (biorhythm.Physical === "high") {
    ...
    protocols.push("Movement (Vyana): 20-30 min walk/dance/exercise — honor Physical peak");
    protocols.push("Grounding Breath (Apana): 8 cycles 4-7-8 — root energy after movement");
  } else if (biorhythm.Physical === "low") {
    vayu = "Apana"; // Downward grounding
    protocols.push("Rest (Apana): Restorative yoga, gentle stretching — honor Physical trough");
    protocols.push("Deep Sleep Priority: 8+ hours tonight — body needs recovery");
    protocols.push("Grounding Breath (Apana): 8 cycles 4-7-8 — root downward, no forcing");
  }
}
...
if (dominantCycle === "Emotional") {
  if (biorhythm.Emotional === "high") {
    ...
    protocols.push("Social Engagement (Prana): Connect with friends/community — honor Emotional peak");
    protocols.push("Creative Expression: Art, music, dance — channel high Emotional energy");
    ...
    protocols.push("Emotional Release: Journal, cry if needed — let low cycle move through");
    protocols.push("Grounding Breath (Apana): 8 cycles 4-7-8 — support Emotional descent");
  }
}
...
if (dominantCycle === "Intellectual") {
  if (biorhythm.Intellectual === "high") {
    ...
    protocols.push("Deep Work (Udana): Writing, coding, complex problem-solving — honor Intellectual peak");
    protocols.push("Learning: Study new material, teach others — express upward");
    protocols.push("13-Count Transformation Breath: 13 cycles — catalyze mental clarity into action");
  } else if (biorhythm.Intellectual === "low") {
    vayu = "Samana"; // Navel, integration
    protocols.push("Simple Tasks (Samana): No new learning, easy admin work — honor Intellectual trough");
    protocols.push("Reflection (Samana): Meditate, integrate recent learning — digest vs. intake");
  }
}
...
if (dominantCycle === "Spiritual") {
  if (biorhythm.Spiritual === "high") {
    ...
    protocols.push("Meditation (Prana): Sit in receptive stillness — honor Spiritual peak");
    protocols.push("Spiritual Study (Udana): Read sacred texts, vision work — express wisdom");
  } else if (biorhythm.Spiritual === "low") {
    vayu = "Apana"; // Grounding
    protocols.push("Embodied Practice (Apana): Breathwork, ritual, nature walk — ground mystical seeking");
...
protocols.push(`**Power Number: ${powerNumber}** — ${getPowerNumberContext(powerNumber, biorhythm)}`);
...
function getPowerNumberContext(powerNumber, biorhythm) {
  if (powerNumber === 8) return "Balance/Grounding — honor cycle extremes with grounding protocols";
  if (powerNumber === 13) return "Transformation — catalyze high cycle energy into grounded action";
  if (powerNumber === 19) return "Solar Leadership — multiple peaks align, express power outward";
  return "Octave Balance — default grounding";
}
```
...
Euterpe says: ${getEuterpeWisdom(dominantCycle)} 🌀
`;

function getTerpsichoreWisdom(cycle) {
  if (cycle === "Physical") return "Dance your body's rhythm — high or low, honor the movement.";
  if (cycle === "Emotional") return "Embody your feelings — let them move through you, not against you.";
  if (cycle === "Intellectual") return "Think with your body — walk while pondering, move while creating.";
  if (cycle === "Spiritual") return "Ground your mysticism — spirit lives in flesh, not above it.";
}

function getEuterpeWisdom(cycle) {
  return "Harmonize with your cycle — move WITH, never against.";
}
```
...
**Next Step:** Dispatch to implementation agent 🚀
