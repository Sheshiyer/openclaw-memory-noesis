...
**Input Files:**
- Profile data: `profile.json` (location TBD — likely in Selemene-engine or `koshas/brahmasthana/USER.md`)
- Optional: `memory/biorhythm-history.json` (past cycle tracking for pattern memory)

**Output Files:**
- **Daily Log:** `koshas/manomaya/logs/YYYY-MM-DD.md` (append cycle summary)
- **Kosha Tracking:** `koshas/brahmasthana/OPENCLAW-KOSHA-TRACKING.md` (Khalorēē impact)
...
**Audit Documentation:**
- `koshas/manomaya/distillation/CRON-AUDIT-2026-02-05.md` (line 262)
