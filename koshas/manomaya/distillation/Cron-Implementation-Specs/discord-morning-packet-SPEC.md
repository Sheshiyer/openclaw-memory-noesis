...
**Old Purpose:**
> Share reflection on `koshas/manomaya/meta/nightly-builds.md` to #nightly-builds. Encourage community engagement and feedback.
...
**Input File:** `koshas/manomaya/meta/nightly-builds.md`
...
**Input:**
- `koshas/manomaya/meta/nightly-builds.md` (primary source)
- `koshas/manomaya/logs/YYYY-MM-DD.md` (context for recent activity)

**Output:**
- Discord #nightly-builds (ephemeral, not archived)
- `koshas/manomaya/logs/YYYY-MM-DD.md` (append job execution summary)
...
**Source Files:**
- `koshas/manomaya/meta/nightly-builds.md` (primary input, currently missing — needs creation by nightly-builder)
- `koshas/manomaya/distillation/CRON-AUDIT-2026-02-05.md` (line 254, job context)
