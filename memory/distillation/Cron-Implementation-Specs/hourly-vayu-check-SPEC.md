...
- `/Volumes/madara/2026/twc-vault/memory/kernel/VEDIC-LEXICON.md` (canonical Vayu definitions)

**Output Directories:**
- `/Volumes/madara/2026/twc-vault/01-Projects/Products/Churned-Content/Audio/` (archive generated voice files)
- `/Volumes/madara/2026/twc-vault/memory/kernel/OPENCLAW-KOSHA-TRACKING.md` (append hourly entries)

**Memory Files:**
- **Primary:** `OPENCLAW-KOSHA-TRACKING.md` (append entry with Vayu, time, Khalorēē impact)
- **Secondary:** `memory/logs/YYYY-MM-DD.md` (daily summary of breath deliveries)
...
**Vedic Lexicon:**
- `/Volumes/madara/2026/twc-vault/memory/kernel/VEDIC-LEXICON.md` (canonical 100 Tatvas)
- `/Volumes/madara/2026/twc-vault/memory/kernel/KHA.md` (10 Vayus, 3 Doshas, Khalorēē)
- `/Volumes/madara/2026/twc-vault/memory/kernel/BHA.md` (3 Gunas, 8 Vikara)
- `/Volumes/madara/2026/twc-vault/memory/kernel/PANCHA-KOSHA.md` (5 layers + Layer 0)

**Audit Documentation:**
- `/Volumes/madara/2026/twc-vault/memory/distillation/CRON-AUDIT-2026-02-05.md` (jobs #1 & #2)

**Audio Resources:**
- `/Volumes/madara/2026/twc-vault/03-Resources/Media/Audio/Breathwork/Stubs/` (opus files)

**Tracking:**
- `/Volumes/madara/2026/twc-vault/memory/kernel/OPENCLAW-KOSHA-TRACKING.md` (live layer awareness)
