...
- **Chitta (Memory/Storage):** Logs theme to `/Volumes/madara/2026/twc-vault/memory/logs/YYYY-MM-DD.md` and updates `OPENCLAW-KOSHA-TRACKING.md`
...
- Logs to memory only: `/Volumes/madara/2026/twc-vault/memory/logs/YYYY-MM-DD.md`
...
**Input Directories:**
- `/Volumes/madara/2026/twc-vault/memory/kernel/SOUL.md` (read Antahkarana definitions)
- `/Volumes/madara/2026/twc-vault/memory/kernel/VEDIC-LEXICON.md` (read Tithi definitions)

**Output Directories:**
- `/Volumes/madara/2026/twc-vault/memory/logs/YYYY-MM-DD.md` (write daily lunar theme)
- `/Volumes/madara/2026/twc-vault/memory/kernel/OPENCLAW-KOSHA-TRACKING.md` (update Khalorēē log)

**State Files (Coordination):**
- `/Volumes/madara/2026/twc-vault/memory/kernel/lunar-state.json` (shared state for 3 subsidiary jobs)
  ```json
  {
    "currentTithi": 8,
    "paksha": "Shukla",
...
4. Store in memory/logs/YYYY-MM-DD.md for downstream jobs
...
**Vedic Lexicon:**
- `/Volumes/madara/2026/twc-vault/memory/kernel/VEDIC-LEXICON.md` (Tithi definitions, Paksha, Amavasya, Purnima)
- `/Volumes/madara/2026/twc-vault/memory/kernel/SOUL.md` (Antahkarana: Buddhi, Mana, Chitta, Aham)
- `/Volumes/madara/2026/twc-vault/memory/kernel/KHA.md` (Vyana Vayu, Dosha timing)
...
**Audit Documentation:**
- `/Volumes/madara/2026/twc-vault/memory/distillation/CRON-AUDIT-2026-02-05.md` (Lunar Resonance category, jobs #8-11)
